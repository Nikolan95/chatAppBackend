                    ...
                    <div class="header">
                        <div class="header-top">
                            <div class="logo ml-2 mt-3">
                                <a href="index.html">
                                    <img src="{{asset('images/logo.png')}}" class="header_image img-fluid" alt="">
                                </a>
                            </div>
                        ...
                        <ul class="user-list">
                            ...
                            <li class="user-list-item unread">
                                ...
                                <div class="users-list-body">
                                    <div>
                                        <a href ="/conversation/{{$line['id']}}">
                                            <h5>{{$line['user']->name }}</h5>
                                            <p>{{ $line['messages']->last()->body }}</p>
                                        </a>
                                    </div>
                                    <div class="last-chat-time">
                                        <small class="text-muted">{{ Carbon\Carbon::parse($line['messages']->last()->created_at)->diffForHumans()}}</small>
            ...
            <div class="chat" id="middle">
                <div class="chat-header">
                    <div class="user-details">
                        ...
                        <div class="mt-1">
                            <h5 class="mb-1">{{$conversation[0]['user']->name}}</h5>
                            <small class="text-muted mb-2">
                                Active: {{ Carbon\Carbon::parse($conversation[0]['messages']->last()->created_at)->diffForHumans()}}
                            </small>
                        </div>
                    </div>
                                    ...
                                    <nav class="list-group list-group-flush mb-n6">
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar avatar-online mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-7.jpg')}}" alt="Anna Bridges">
                                                    </div>
                                                    <div
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-1.jpg')}}" alt="Brian Dawson">
                                                    </div>
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-2.jpg')}}" alt="Leslie Sutton">
                                                    </div>
                                                    <div class="media-body align-self-center mr-6 group_card_media">
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-3.jpg')}}" alt="Matthew Wiggins">
                                                    </div>
                                                    <div class="media-body align-self-center mr-6 group_card_media">
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-4.jpg')}}" alt="Simon Hensley">
                                                    </div>
                                                    <div class="media-body align-self-center mr-6 group_card_media">
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-5.jpg')}}" alt="William Wright">
                                                    </div>
                                                    <div class="media-body align-self-center mr-6 group_card_media">
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-6.png')}}" alt="William Greer">
                                                    </div>
                                                    <div class="media-body align-self-center mr-6 group_card_media">
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="avatar mr-5">
                                                        <img class="avatar-img group_image" src="{{asset('images/avatar-8.jpg')}}" alt="Zane Mayes">
                                                    </div>
                                                    <div
                                                        class="media-body align-self-center mr-6 group_card_media">
